# Functional Python [![](https://github.com/wdeforest23/functional-python/workflows/tests/badge.svg)](https://github.com/wdeforest23/functional-python/actions?query=workflow%3Atests)
